...
BlockController.prototype.getBlockReward = function(height) {
  var subsidy = new BN(777 * 1e8);

  
if ( height > 30001 ) subsidy *= 15000;
    else if ( height > 200001 ) nSubsidy = (7500 * COIN);
    else if ( height > 400001 ) nSubsidy = (3750 * COIN);
    else if ( height > 700001 ) nSubsidy = (1875 * COIN);
    else if ( height > 1100001 ) nSubsidy = (937,5 * COIN);
    else if ( height > 1600001 ) nSubsidy = (468,75 * COIN);
    else if ( height > 2200001 ) nSubsidy = (234,37 * COIN);
    else if ( height > 2800001 ) nSubsidy = (117,18 * COIN);
    else if ( height > 3600001 ) nSubsidy = (58,59 * COIN);
    else if ( height > 4500001 ) nSubsidy = (29,29 * COIN);
    else if ( height > 5500001 ) nSubsidy = (14,64 * COIN);
    else if ( height > 6600001 ) nSubsidy = (7,32 * COIN);
    else if ( height > 7800001 ) nSubsidy = (3,66 * COIN);
    else if ( height > 9100001 ) nSubsidy = (1,83 * COIN);
