...
if ( Height < 77777 ) nSubsidy = (21000 * COIN);
    else if ( Height < 97777 ) nSubsidy = (20000 * COIN); //+20k blocks
    else if ( Height < 117777 ) nSubsidy = (19000 * COIN);
    else if ( Height < 137777 ) nSubsidy = (18000 * COIN);
    else if ( Height < 157777 ) nSubsidy = (17000 * COIN);
    else if ( Height < 177777 ) nSubsidy = (16000 * COIN);
    else if ( Height < 197777 ) nSubsidy = (15000 * COIN);
    else if ( Height < 217777 ) nSubsidy = (14000 * COIN);
    else if ( Height < 237777 ) nSubsidy = (13000 * COIN);
    else if ( Height < 257777 ) nSubsidy = (12000 * COIN);
    else if ( Height < 277777 ) nSubsidy = (11000 * COIN);
    else if ( Height < 297777 ) nSubsidy = (10000 * COIN);
    else if ( Height < 317777 ) nSubsidy = (9000 * COIN);
    else if ( Height < 337777 ) nSubsidy = (8000 * COIN);
    else if ( Height < 367777 ) nSubsidy = (7000 * COIN); //+30k blocks
    else if ( Height < 417777 ) nSubsidy = (6000 * COIN); //+50k blocks
    else if ( Height < 467777 ) nSubsidy = (5000* COIN);
    else if ( Height < 517777 ) nSubsidy = (4000 * COIN);
    else if ( Height < 567777 ) nSubsidy = (3000 * COIN);
    else if ( Height < 617777 ) nSubsidy = (2000 * COIN);
    else if ( Height < 667777 ) nSubsidy = (1000 * COIN);
    else if ( Height < 717777 ) nSubsidy = (900 * COIN);
    else if ( Height < 777777 ) nSubsidy = (777 * COIN);
    else if ( Height < 817777 ) nSubsidy = (700 * COIN);
    else if ( Height < 867777 ) nSubsidy = (600 * COIN);
    else if ( Height < 917777 ) nSubsidy = (500 * COIN);
    else if ( Height < 967777 ) nSubsidy = (400 * COIN);
    else if ( Height < 1017777 ) nSubsidy = (300 * COIN);
    else if ( Height < 1067777 ) nSubsidy = (200 * COIN);
    else if ( Height < 1117777 ) nSubsidy = (100 * COIN);
    else if ( Height < 1167777 ) nSubsidy = (77 * COIN);
    else if ( Height < 1217777 ) nSubsidy = (47 * COIN);
    else if ( Height < 1267777 ) nSubsidy = (37 * COIN);
    else if ( Height < 1317777 ) nSubsidy = (27 * COIN);
    else if ( Height < 1367777 ) nSubsidy = (17 * COIN);
    else {
